...
const useStyles = makeStyles<Theme, NotificationPanelProps>((theme: Theme) => ({
    root: {
...
const NotificationPanel: FunctionComponent<NotificationPanelProps> = (props: NotificationPanelProps) => {
    const { onClosePanel, show } = props;
    ...
    return (
        <Fragment>
            <div className='dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg show'>
                <OutsideClickHandler onOutsideClick={handleClosePanel}>
                    <form>
                        <div
                        ...
                        >
                            <h4 className='d-flex flex-center rounded-top'>
                                ...
                                <span className='btn btn-text btn-success btn-sm fw-bold btn-font-md ms-2'>23 new</span>
                            </h4>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className='d-flex align-items-center mb-6'>
                                        ...
                                        <div className='d-flex flex-column fw-bold'>
                                            <a href='#' className='text-gray-800 text-hover-primary mb-1 font-size-lg'>
                                                Awesome SAAS
                                            </a>
                                ...
                                <div className='d-flex flex-center pt-7'>
                                    <a href='#' className='btn btn-light-primary fw-bold text-center'>
                                        See All
                                    </a>
                                </div>
                            </div>
                                ...
                                >
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navi-text'>
                                                <div className='fw-bold'>New report has been received</div>
                                    ...
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navi-text'>
                                                <div className='fw-bold'>Finance report has been generated</div>
                                    ...
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navi-text'>
                                                <div className='fw-bold'>New order has been received</div>
                                    ...
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navi-text'>
                                                <div className='fw-bold'>New customer is registered</div>
                                    ...
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navi-text'>
                                                <div className='fw-bold'>Application has been approved</div>
                                                <div className='text-muted'>3 hrs ago</div>
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navinavinavi-text'>
                                                <div className='fw-bold'>New file has been uploaded</div>
                                    ...
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navi-text'>
                                                <div className='fw-bold'>New user feedback received</div>
                                    ...
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navi-text'>
                                                <div className='fw-bold'>New order has been placed</div>
                                    ...
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navi-text'>
                                                <div className='fw-bold'>Company meeting canceled</div>
                                    ...
                                    <a href='#' className='navi-item'>
                                        <div className='navi-link'>
                                            ...
                                            <div className='navi-text'>
                                                <div className='fw-bold'>New customer comment recieved</div>
