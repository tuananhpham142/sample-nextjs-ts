import { importWithRetry } from '@/utils/importWithRety.utils';
import { ComponentType, lazy, LazyExoticComponent, useEffect, useRef } from 'react';
 ...
 */
type ModuleWithNamedExport<TComponent extends AnyComponent, TNamedImport extends string> = {
 ...
 * component
 */
type NamedImportFactory<TComponent extends AnyComponent, TNamedImport extends string> = () => Promise<
    ModuleWithNamedExport<TComponent, TNamedImport>
>;
 ...
 */
interface UseLazyComponentOptions<TComponent extends AnyComponent, TNamedImport extends string> {
    preload?: boolean;
 ...
 */
export function useLazyComponent<TComponent extends AnyComponent, TNamedImport extends string>(
 ...
 */
export function useLazyComponent<TComponent extends AnyComponent, TNamedImport extends string>(
    factory: DefaultImportFactory<TComponent> | NamedImportFactory<TComponent, TNamedImport>,
